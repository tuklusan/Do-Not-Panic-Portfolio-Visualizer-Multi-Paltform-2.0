...
{
    public const string MaxTraceMegabytesEnvironmentVariable = "DONOTPANICPORTFOLIOVISUALIZER2_TRACE_MAX_MB";
    public const string DeprecatedMaxTraceMegabytesEnvironmentVariable = "DONOTPANICPORTFOLIOVISUALIZER_TRACE_MAX_MB";
    ...
    public static int ResolveMaxTraceBytes()
    {
        ...
        if (string.IsNullOrWhiteSpace(configured))
            configured = Environment.GetEnvironmentVariable(DeprecatedMaxTraceMegabytesEnvironmentVariable)?.Trim();
