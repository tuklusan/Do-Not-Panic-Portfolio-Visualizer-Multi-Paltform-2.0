...
The Phase 0 through Phase 6 migration baseline is complete at pushed commit
`7e662d4`. The active product is a .NET 10 Avalonia desktop application on
...
All tracked CRs through the Phase 6 migration baseline are closed. CR-011
records real degraded-mode acceptance on all three local machines. CR-012
