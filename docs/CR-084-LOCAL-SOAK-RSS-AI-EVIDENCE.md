...
| CR-01 | Local real-product soaks prove configured RSS playback and successful AI generation without credential leakage | local soak coordinator and circular trace | per-machine evidence manifests |
