...
function Invoke-WindowsValidation {
    ...
    if ($CaptureProductScene) {
        ...
        $scriptLines = @(
            ...
            '$startInfo.EnvironmentVariables[''DONOTPANICPORTFOLIOVISUALIZER2_LOCALDATA_ROOT''] = $localDataRoot',
            '$startInfo.EnvironmentVariables[''DNPPV_OPENROUTER_API_KEY''] = $env:DNPPV_OPENROUTER_API_KEY',
            '$startInfo.EnvironmentVariables[''DNPPV_SOAK_REQUIRE_AI_NEWS''] = $env:DNPPV_SOAK_REQUIRE_AI_NEWS',
