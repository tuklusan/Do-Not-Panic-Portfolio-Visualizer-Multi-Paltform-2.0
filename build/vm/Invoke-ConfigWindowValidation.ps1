...
function Invoke-WindowsValidation {
    ...
    if ($CaptureProductScene) {
        ...
        $scriptLines = @(
            ...
            '    if ($null -eq $invokePattern) { throw ''The File menu item does not expose InvokePattern.'' }',
            ...
            '    if ($null -eq $exitMenu -or $exitMenu.Current.IsOffscreen) { throw ''The File menu submenu was not visible after invocation.'' }',
