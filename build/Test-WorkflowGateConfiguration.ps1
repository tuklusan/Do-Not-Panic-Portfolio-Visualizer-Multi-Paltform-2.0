...
foreach ($pattern in @('B-001', 'B-002', 'NTP-(?:ALL-HOSTS-FAILED|TIME-SYNC-FAILURE|RECURRING-AT-SHUTDOWN)', 'AI-NEWS-SUMMARIZATION-', 'AI\s+summari[sz]', 'LocalClockFallback', 'hasBoundedRenderRecovery')) {
